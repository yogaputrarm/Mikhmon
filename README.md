...
## Kesimpulan
<p align=center"> Berdasarkan hasil dari Perancangan Jaringan Hotspot Voucher Dengan Mikrotik Menggunakan Mikhmon Pada Kantin Sekolah ini dapat diambil sebuah kesimpulan yaitu : 
<p align=center"> Dalam proyek ini penekanan utama adalah pada pengembangan manajemen akses dan administrasi penggunaan hotspot untuk meningkatkan kualitas layanan internet. Dalam teknologi internet, khususnya layanan hotspot Wi-Fi, telah menjadi aspek vital dalam kegiatan sehari-hari seperti pendidikan, sosial, dan bisnis. Dalam upaya meningkatkan pengalaman pengguna, manajemen hotspot berbasis voucher seperti yang diimplementasikan menggunakan Mikhmon telah membawa beberapa perubahan positif. Hal ini tidak hanya memberikan kenyamanan bagi pengguna internet dalam mengakses layanan, namun juga mempermudah penyedia layanan untuk mengontrol dan mengelola akses secara efektif. Metode pengumpulan data melalui studi literatur dan observasi langsung memberikan landasan kuat dalam perancangan proyek ini serta membantu untuk mengidentifikasi tantangan dan kebutuhan yang ada.
<p align=center"> Dengan fokus pada kebutuhan praktis pengguna proyek ini mampu menggarisbawahi pentingnya sistem manajemen yang efektif dalam mengatur penggunaan internet. Melalui implementasi MikroTik dan Mikhmon, kesimpulan dari proyek ini menegaskan bahwa sistem voucher telah membuka ruang bagi administrator untuk lebih mudah mengontrol akses internet secara terpusat, memberikan kemudahan dalam mengkustomisasi layanan sesuai dengan kebutuhan pengguna, dan juga meningkatkan keamanan secara signifikan. Dengan demikian, proyek ini berhasil mencapai tujuan dalam membantu meningkatkan kualitas layanan internet dengan pendekatan yang lebih terkelola dan efisien.
